import {
    COURSE_GET_ONE,
    COURSE_GET_MODULE_ONE,
    COURSE_GET_MATERIAL_ONE,
    COURSE_GET_TUTOR_ONE,
    COURSE_GET_MULTIPLE,
    COURSE_GET_MODULE_MULTIPLE,
    COURSE_GET_MATERIAL_MULTIPLE,
    COURSE_GET_TUTOR_MULTIPLE,
    COURSE_REGISTER_SUCCESS,
    COURSE_REGISTER_MODULE_SUCCESS,
    COURSE_REGISTER_MATERIAL_SUCCESS,
    COURSE_REGISTER_TUTOR_SUCCESS,
    COURSE_REGISTER_FAIL,
    COURSE_REGISTER_MODULE_FAIL,
    COURSE_REGISTER_MATERIAL_FAIL,
    COURSE_REGISTER_TUTOR_FAIL,
    COURSE_LOADING,
    COURSE_MODULE_LOADING,
    COURSE_MATERIAL_LOADING,
    COURSE_TUTOR_LOADING,
    COURSE_LOADING_ERROR,
    COURSE_LOADING_MODULE_ERROR,
    COURSE_LOADING_MATERIAL_ERROR,
    COURSE_LOADING_TUTOR_ERROR,
    COURSE_UPDATE_SUCCESS,
    COURSE_UPDATE_MODULE_SUCCESS,
    COURSE_UPDATE_MATERIAL_SUCCESS,
    COURSE_UPDATE_TUTOR_SUCCESS,
    COURSE_UPDATE_FAIL,
    COURSE_UPDATE_MODULE_FAIL,
    COURSE_UPDATE_MATERIAL_FAIL,
    COURSE_UPDATE_TUTOR_FAIL,
    COURSE_DELETE_SUCCESS,
    COURSE_DELETE_MODULE_SUCCESS,
    COURSE_DELETE_MATERIAL_SUCCESS,
    COURSE_DELETE_TUTOR_SUCCESS,
    COURSE_DELETE_FAIL,
    COURSE_DELETE_MODULE_FAIL,
    COURSE_DELETE_MATERIAL_FAIL,
    COURSE_DELETE_TUTOR_FAIL,
    COURSE_EDIT
} from "../types/course";
...
const initialState = {
    ...
    isLoading: false,
    courses: courseStore,
    coursemodules: coursemoduleStore,
    coursematerials: coursematerialStore,
    coursetutors: coursetutorStore,
    course:{},
    coursemodule:{},
    coursematerial:{},
    coursetutor:{},
