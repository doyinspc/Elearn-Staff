...
import { SERVER_PATHS, SERVER_URL } from './../../actions/common';
         ...
         {this.state.st ? <CardShow mid={this.props.data.id} data ={this.props.data} st={this.state.st}/>: ''}
            ...
            <Col md='6' className="text-right"> 
              <div class='btn-group btn-xs'>
                ...
                <Button class="btn-primary btn-xs" onClick={()=>this.handleActive(0)}><i class="fa fa-eye"></i></Button>:
                <Button class="btn-primary btn-xs" onClick={()=>this.handleActive(1)}><i class="fa fa-eye-slash text-danger"></i></Button>}
                <Button class="btn-primary btn-xs" onClick={()=>this.props.handleEdit(this.props.data.id)}><i class="fa fa-edit"></i></Button>
                <Button class="btn-danger btn-xs" onClick={()=>this.props.handleDelete(this.props.data.id)}><i class="fa fa-trash"></i></Button>
              </div>
            </Col>
          </Row>
      </>
