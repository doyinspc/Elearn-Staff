              ...
              <Card className="card-login card-plain" style={{zIndex:100}}>
                <Form action="" className="form" method="" onSubmit={this.onSubmit}>
                  ...
                  <CardBody style={{ marginTop:5 }}>
                    ...
                    </Col>: <Col sm={6} class="container"style={{minHeight:'100%'}}  >
                      <div class="row h-100 justify-content-center align-items-center">
                        <h1><i className="now-ui-icons loader_gear"></i></h1>
                        <h4 class="md-block">Loading</h4>
                        </div></Col>}
                    </Row>
                     </CardBody>
...
const mapStateToProps = state => ({ 
  isLoading: state.userstudentReducer.isLoading,
  isRegistered: state.userstudentReducer.isRegistered
})
